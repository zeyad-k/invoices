        ...
        <ul class="side-menu">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        @can('الفواتير الغير مدفوعة')
                            <li><a class="slide-item" href="{{ route('invoices_unpaid') }} ">الفواتير الغير
                                    مدفوعة</a>
                            </li>
                        @endcan

                        @can('الفواتير المدفوعة جزئيا')
                            <li><a class="slide-item" href="{{ route('invoices_partiallyPaid') }}">الفواتير المدفوعة
                                    جزئيا</a>
                            </li>
                        @endcan
                        @can('ارشيف الفواتير')
            ...
            @can('التقارير')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        @can('تقرير الفواتير')
                            <li><a class="slide-item" href="{{ route('invoices_report-index') }}">تقارير الفواتير</a></li>
                        @endcan
                        @can('تقرير العملاء')
                            <li><a class="slide-item" href="{{ route('customers_report-index') }}">تقارير العملاء</a>
                            </li>
                        @endcan
