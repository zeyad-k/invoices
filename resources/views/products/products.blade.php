                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                                    data-id="{{ $x->id }}"
                                                    data-product_name="{{ $x->product_name }}" data-toggle="modal"
                    ...
                    <div class="modal-content modal-content-demo">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('products.store') }}" method="post">
                                ...
                                <div class="form-group">
                                    <label for="inLineFormCustomSelectPref">القسم</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="description" name="description" ro ws="3" placeholder="ملاحظات"></textarea>
                                </div>
